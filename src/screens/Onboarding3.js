        ...
        <View style={Onboarding1Styles.contentContainer}>
          ...
          <View style={[Onboarding1Styles.buttonContainer, {
            ...
            <View style={Onboarding1Styles.titleContainer}>
              <Text style={[Onboarding1Styles.title, { color: colors.text }]}>Di dukung payment gateway</Text>
              <Text style={Onboarding1Styles.subTitle}>Cozzy.id</Text>
            </View>

            <Text style={[Onboarding1Styles.description, { color: colors.text }]}>
            Pemesanan kamar dapat di lakukan menggunakan kartu kredit, QRIS, transfer dan beberapa opsi pembayarn lain nya.
            </Text>
