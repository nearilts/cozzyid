    ...
    return (
        <TouchableOpacity onPress={onPress} style={styles.button}>
            <View style={[
                ...
                <Text style={{ color:isSelected ?COLORS.white: COLORS.dark, fontWeight:'bold', fontSize:18 }}>{label}</Text>
                <Text style={{ color:isSelected ?COLORS.white: COLORS.dark,  fontSize:15 }}>{price}</Text>
            </View>
        </TouchableOpacity>
    );
};
